...
//
create function prorate(empno varchar(6),fromdate datetime,todate datetime,amount numeric(13,2))  returns numeric(13,2)
begin
...
--  deallocate curisrosterbased
  ...
  -- proration for both join and resign date
          ...
          --  return   fromdate;  2010-01-01 00:00:00
       -- return   joindate;  2010-01-13 00:00:00

--		return todate;  2010-01-31 00:00:00
 	 -- return resigndate;2011-01-31
         ...
         if (calcsundays = 0) then
            ...
            if (calcsundays = 1)  then
             ...
             -- set @prtdays= datediff(day,@fromdate,@joindate) -  @nsundays + 1
                 -- set notworkingdays = timestampdiff(day,fromdate,joindate);
			set prtdays  = timestampdiff(day,joindate,todate) -nsundays+1;
