 ...
 */
	...
	$lang_Error_DependantNameEmpty					= "Dependent name is empty";
        $lang_pim_tabs_Ebexam="EB Exam";
        $lang_pim_Other="Other";
        $lang_Menu_Main_Participation="Training Participation";
        $lang_Menu_Main_Participation_Summery="Training Participation Summery";
	...
	$lang_Menu_Admin_Skills_Languages 			= "Languages";
        ...
        $lang_Menu_Admin_Service = "Service";
	...
	$lang_Menu_Admin_Users_HRAdmin 					= "Users";
	...
	$lang_Menu_Admin_CustomFields = "Custom Fields";
        $lang_Menu_Admin_service="Service";
        $lang_Menu_Admin_Grade="Grade";
        $lang_Menu_Admin_Class="Class";
        $lang_Menu_Admin_AtchType="Attachment Type";
	...
	$lang_Menu_Leave_DefineLeavePeriod					= "Define Leave Period";
	...
	$lang_index_WelcomeMes 			= "Welcome";
	$lang_index_ChangePassword 		= "Change Password";
	$lang_index_Logout 				= "Logout";

        $lang_index_WelcomeMes_si 			= "ආයුබෝවන්";
	$lang_index_ChangePassword_si 		= "මුරපදය මාරුකරන්න";
	$lang_index_Logout_si 				= "වරන්න";

        $lang_index_WelcomeMes_ta 			= "ளனளளனள";
	$lang_index_ChangePassword_ta 		= "ளனளனள";
	$lang_index_Logout_ta 				= "விடு பதிகை";
	...
	$lang_pim_tabs_Photo = "Photograph";
        $lang_pim_tabs_serviceRecord="Service Record";
	...
	// login page
	$lang_login_title = "eHRM - New Level of HR Management";
	...
	$lang_Common_To = "to";
        ...
        //Promotion
        $lang_Menu_Main_Promotion="Promotion";
        $lang_Menu_Sub_Promotion_new="Promotion";
        $lang_Menu_Sub_Promotion_method="Promotion Method";
        $lang_Menu_Sub_Promotion_ChkList="Promotion Ckeck List";
        $lang_Menu_Sub_Probation_ChkList="Probationers";
        //$lang_Menu_Sub_Promotion="New Promotion";

        $lang_Menu_Main_TransferMenu="Transfer";
        $lang_Menu_Main_TransferResMenu="Trans Reason";
        $lang_Menu_Main_NewTransferMenu="New Transfer";
        $lang_Menu_Main_NewTransferRequestMenu="Transfer Request";
        $lang_Menu_Main_TrainNewInstitute="Define Institute";
        $lang_Menu_Main_TrainDev="Training & Developent";
        $lang_Menu_Main_Definecourse="Define Training";
        $lang_Menu_Main_TrainApprovel="Training Approval";
        $lang_Menu_Main_TrainadminEdit="Edit Training Approval";
        $train_directory="Training Directory";

        // Retirement
        $lang_Menu_Main_Retirement="Retirement";
        $lang_Menu_Sub_Retrement_Service_Extension="Service Extension";

        $lang_Menu_Main_AssignTrain="Assign For Training";
        $new_train_assign="Assign new training";
        $train_assign_summery="Training summery";
        $lang_Menu_Main_train_saverequest="Registration";
        $train_record="Training Record";
      


        //WBM
        $lang_Menu_Main_WBM="welfare & Benefit";
        $lang_Menu_Sub_WBM_Disbursement="Benefit Disbursement";
        $lang_Menu_Sub_WBM_BeniftType="Define Type";
        $lang_Menu_Sub_WBM_Benift="Define Benefit";

        //Attendance
        $lang_Menu_Main_Attendance="Attendance";
        $lang_Menu_Sub_Attendance_Day="Define Day Types";
        $lang_Menu_Sub_Attendance_cs="Employee Attendace";
        $lang_Menu_Sub_Attendance_Process="Employee Attendance Summary";
        
        //Disciplinary
        $lang_Menu_Main_Dis="Disciplinary";
        $lang_Menu_Sub_Dis_ActionType="Define type";
        $lang_Menu_Sub_Dis_Actions="Define Offence";
        $lang_Menu_Sub_Dis_Incidents="Incident Reporting";
        $lang_Menu_Sub_Dis_finalaction="Final Action";
        $lang_Menu_Sub_Dis_Inquery="Incident Inquiry";
        $lang_Menu_Sub_Dis_CloseSummery="Closed Incident Summary";

        //Knowledge Base
        $lang_Menu_Main_KNW="Knowledge Base";
        $lang_Menu_Sub_KNW_Doc_type="Define Document Type/Group";
        $lang_Menu_Sub_KNW_Att="Attach Document";
        $lang_Menu_Sub_KNW_knw="Use Knowledge Base";
        $lang_Menu_Sub_KNW_Art="Knowledge Share";

        //Personal File
        $lang_Menu_Main_PF="Personal File";
        $lang_Menu_Sub_PF_view="Personal File List";
        $lang_Menu_Sub_PF_pf="Personal File Define";

        //Security Module

        $lang_Menu_Sub_SM_capability="Capability";
        $lang_Menu_Sub_SM_menu_capability="Menu Capability";
        $lang_Menu_Sub_SM_employee_capability="Employee Capability";
        $lang_Menu_Sub_SM_report_capability="Report Capability";
        $lang_Menu_Main_SM="Security";

        //Leave
        $lang_Menu_Main_leave="Leave";
        $lang_Menu_Sub_leave_type="Deifne Leave Type";
        $lang_Menu_Sub_leave_configuration="Leave Configuration";
        $lang_Menu_sub_leave_holiday="Define Day OFF";
        $lang_Menu_Sub_leave_entitlement="Leave Entitlement";
        $lang_Menu_Sub_leave_apply="Apply Leave";
        $lang_Menu_Sub_leave_search="Leave Summary";