...
class EmpInfo {
    ...
    /* NOTE:
     * These are also defined in the JobTitle class. Moved here to avoid 
     * class name conflict when working with authorize class in new symfony code
     */
    ...
    */
    ...
    function getUnAssEmployeeRepTo($pageNO, $schStr, $mode, $sortField = 0, $sortOrder = 'ASC') {
        ...
        $arrFieldList[1] = "CONCAT(EMP_FIRSTNAME, ' ', EMP_LASTNAME)";
        $arrFieldList[2] = 'EMPLOYEE_ID';
    ...
    public function isManager($empNumber) {
        ...
        return $this->checkEmpJobTitle($empNumber, self::MANAGER_JOB_TITLE_NAME);
    }
    ...
    public function isDirector($empNumber) {
        ...
        return $this->checkEmpJobTitle($empNumber, self::DIRECTOR_JOB_TITLE_NAME);
    }
