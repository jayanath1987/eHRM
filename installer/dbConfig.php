...
<?php if ($_SESSION['cMethod'] == 'new') { ?>
	...
	if(document.frmInstall.chkSameUser.checked && frm.dbOHRMUserName.value == '') {
		alert('eHRM DB User-name left Empty');
...
<tr>
	<td class="tdComponent">Use the same Database User for eHRM</td>
...
<?php  } ?>
<tr>
	<td class="tdComponent">eHRM Database Username</td>
	<td class="tdValues"><input type="text" name="dbOHRMUserName" <?php echo isset($_POST['chkSameUser']) ? 'disabled' : '' ?> value="<?php echo  isset($_SESSION['dbInfo']['dbOHRMUserName']) ? $_SESSION['dbInfo']['dbOHRMUserName'] : 'ehrm'?>" tabindex="7"> #</td>
</tr>
<tr>
	<td class="tdComponent">eHRM Database User Password</td>
...
<div id="oDescription">
<font size="1"># eHRM database user should have the rights to insert data into table, update data in a table, delete data in a table.</font>
</div>
