...
<link href="style.css" rel="stylesheet" type="text/css" />
  ...
  <div id="content">
	<h2>Step 5: Confirmation</h2>
        ...
        <p>All information required for eHRM installation collected in the earlier
...
<?php if(isset($_SESSION['dbInfo']['dbOHRMUserName'])) { ?>
		<tr>
			<td class="tdComponent">eHRM Database User-name</td>
			<td class="tdValues"><?php echo $_SESSION['dbInfo']['dbOHRMUserName']?></td>
		</tr>
<?php } ?>
		<tr>
			<td class="tdComponent">eHRM Admin User Name</td>
