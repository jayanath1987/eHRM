...
<div style="display: block;" class="wrapper">
	<h2>Step 7: Registration</h2>
	 <p>You have sucessfully installed eHRM, please take a moment to register.</p>
    ...
    <div class="wrapper_content_div">
        <h3>Benefits of Registration</h3>
	        <ul class="registration">
	            ...
	            <li><span>Receive eHRM newsletter and other useful updates</span></li>
	        </ul>
    </div>
		...
		if($reqAccept) { ?>
	        <p>Registration information was collected, and Succesfully sent to eHRM.com</p>
        <?php } else { ?>
    	    <p class="error">Registration information was collected, but NOT sent to eHRM.com, please click Retry to try again, or click Skip to proceed and login into OrangeHRM</p>
            <?php }
	}
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
        <td colspan="2" style="padding-top: 10px; font-size: 10px;">
