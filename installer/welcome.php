...
function welcomeSubmit() {
	...
	<div id="content">
		<h2>Welcome to the eHRM ver 1.0 Setup Wizard</h2>


		<p>This installer creates the eHRM database tables and sets the
		...
		<h4 id="welcomeLink"><a href="http://www.hsenidbiz.com" target="_blank" tabindex="36">eHRM</a></h4>
