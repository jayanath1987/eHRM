...
if ($sysConfs->isCasEnable == "YES") {
    ...
    if ($rset[0][5] == 'Enabled') {
        ...
        if ($rset[0][15] == '1' || $rset[0][3] == 'USR001') {
            ...
            $_SESSION['capability'] = $rset[0][10];
            $_SESSION['fname'] = $rset[0][2];
            $_SESSION['language'] = $rset[0][11];
            $_SESSION['emp_name'] = $rset[0][12];
            $_SESSION['emp_name_si'] = $rset[0][13];
            $_SESSION['emp_name_ta'] = $rset[0][14];
            ...
            header("Location: ./symfony/web/index.php/default/index");
...
<?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" valign="bottom"><input type="button" onclick="test();" name="clear" value="<?php echo $lang_login_Clear; ?>" class="button" tabindex="4"/></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <?php
                                                if (isset($InvalidLogin)) {
                                                    switch ($InvalidLogin) {
                                                        ...
                                                        case 5 : $InvalidLoginMes = $lang_login_EmployeeTerminated;
                                                            break;
                                                        case 10 : $InvalidLoginMes = $lang_login_EmployeeTerminated;
                                                            break;
                                                    }
                                                } else {
                                                    $InvalidLoginMes = "&nbsp;";
                                ...
                                <script type="text/javascript">
                                    ...
                                    function test(){
                                        document.loginForm.txtUserName.value = "";
                    ...
                    <tr>
                        ...
                        <td colspan="3" valign="top"><table width="80%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="bodyTXT">
                                        <font color="#6C7E89" size="2" face="Tahoma">e</font>
...
<table width="100%">
    <tr>
        <td align="center"><a href="http://www.icta.lk" target="_blank">ICTA.</a> eHRM</td>
    </tr>
</table>
