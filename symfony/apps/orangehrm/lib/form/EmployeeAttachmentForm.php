 ...
 */
class EmployeeAttachmentForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'txtAttDesc' => new sfWidgetFormInput(),
            'cmbAttachtype'=>new sfWidgetFormInput(),
        ));
        ...
        $this->setValidators(array(
            ...
            'cmbAttachtype'=>new sfValidatorString(array('required' => true)),
        ));
...
//        }
    ...
    public function save() {
        ...
        if ($empAttachment === false) {
            ...
            $empAttachment = new EmpAttachment();
        ...
        $empAttachment->attach_type_id = $this->getValue('cmbAttachtype');
