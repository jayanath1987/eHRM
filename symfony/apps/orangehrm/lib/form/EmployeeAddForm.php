...
class EmployeeAddForm extends sfForm {
 ...
 $marriedDate= LocaleUtil::getInstance()->convertToStandardDateFormat($this->getValue('txtMarriedDate'));
 if($this->getValue('txtMarriedDate')==null){
     $employee->emp_married_date=null;
 }
 else{
            $employee->emp_married_date=$marriedDate;
 }
                //$employee->emp_married_date=($marriedDate = '') ? null : $marriedDate;
        ...
        $employee->rlg_code = ($religion != '0') ? $religion : null;
