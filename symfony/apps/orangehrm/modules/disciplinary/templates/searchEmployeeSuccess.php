...
<?php } ?>
                        <td scope="col">
<?php echo $sorter->sortLink('e.emp_number', __('Employee ID'), '@Diciplinary_employee_search', ESC_RAW); ?>
                        </td>
                        <td scope="col">
<?php echo $sorter->sortLink('e.emp_display_name', __('Employee Name'), '@Diciplinary_employee_search', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                    <?php echo $sorter->sortLink('j.name', __('Designation'), '@Diciplinary_employee_search', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                    <?php echo $sorter->sortLink('s.service_name', __('Service'), '@Diciplinary_employee_search', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                    <?php echo $sorter->sortLink('d.title', __('Division'), '@Diciplinary_employee_search', ESC_RAW); ?>
                        </td>
                    </tr>
                </thead>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnReset").click(function() {
            location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/disciplinary/searchEmployee')) ?>";
                            });
