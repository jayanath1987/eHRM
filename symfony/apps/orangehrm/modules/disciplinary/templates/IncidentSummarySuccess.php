            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            <?php echo $sorter->sortLink('i.dis_inc_id', __('Code'), '@Dis_insident_sum', ESC_RAW); ?>
                        ...
                        <td scope="col">
<?php echo $sorter->sortLink('i.dis_inc_date', __('Incident Date'), '@Dis_insident_sum', ESC_RAW); ?>

                        </td>
                        <td scope="col">
<?php echo $sorter->sortLink('i.dis_inc_prim_summary', __('Incident Summary'), '@Dis_insident_sum', ESC_RAW); ?>

                        </td>
                        <td scope="col">
<?php echo $sorter->sortLink('i.dis_inc_isclosed', __('Status'), '@Dis_insident_sum', ESC_RAW); ?>
...
?>
                            ...
                            <td>
                                ...
                                <input type='checkbox' class='checkbox innercheckbox' name='chkLocID[]' id="chkLoc" value='<?php echo $list->dis_inc_id ?>' />
                            </td>
                            <td>
<?php echo $list->dis_inc_id; ?>
                            ...
                            <td>
                                <a href="<?php echo url_for('disciplinary/UpdateInsident?id=' . $encrypt->encrypt($list->dis_inc_id)) ?>"><?php echo __("Investigate"); ?></a>
                                    </td>
