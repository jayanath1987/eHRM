...
<div class="formpage4col" >
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Add Final Action") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <div class="centerCol">
                <input type="text" style="margin-left: 10px; margin-top: 8px;" id="txtCode"  name="txtCode"   maxlength="10"/>
            </div>
            <br class="clear"/>
            <div class="leftCol">
            ...
            <div class="centerCol">
                <textarea id="txtName"  name="txtName"   class="formTextArea" tabindex="1" rows="3" cols="5" ></textarea>
            </div>


            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea"  tabindex="2" name="txtNamesi" rows="3" cols="5" ></textarea>

            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleComments" class="formTextArea"  tabindex="3" name="txtNameta" rows="3" cols="5" ></textarea>
            ...
            <br class="clear"/>
                        ...
                        <div class="centerCol" style="padding-top: 8px; margin-left: 10px;">
                            ...
                            <select name="cmbType" id="cmbType"  style="width: 160px;">
                                ...
                                <option value="1"><?php echo __("Major"); ?></option>
                                <option value="0"><?php echo __("Minor"); ?></option>
                            </select>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#frmSave").validate({
            ...
            rules: {
                txtCode: { required: true, noSpecialCharsOnly: true },
            ...
            messages: {
                txtCode: { required:"<?php echo __("This field is required") ?>" ,noSpecialCharsOnly:"<?php echo __("Special Characters are not allowed") ?>" },
