...
<div class="formpage4col">
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Edit Level") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <br class="clear"/>
            <div class="leftCol">
                <label for="txtLocationCode"><?php echo __("Level") ?> </label>
                <input name="txtbtid" type="hidden" value="<?php echo $level->getLevel_code() ?>"/>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea" tabindex="1" name="txtName" type="text"><?php echo $level->getLevel_name() ?></textarea>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea" tabindex="2" name="txtNamesi" type="text"><?php echo $level->getLevel_name_si() ?></textarea>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleComments" class="formTextArea" tabindex="3" name="txtNameta" type="text"><?php echo $level->getLevel_name_ta() ?></textarea>
            </div>
            <br class="clear"/>
...
<?php } ?>
                       ...
                       $("#editBtn").click(function() {
                           ...
                           if (editMode == 1) {
                               ...
                               location.href="<?php echo url_for('admin/UpdateLevel?id=' . $encrypt->encrypt($level->getLevel_code()) . '&lock='. $encrypt->encrypt(1)) ?>";
                           }
                           else {
                       ...
                       $("#btnClear").click(function() {
                           ...
                           location.href="<?php echo url_for('admin/UpdateLevel?id=' . $encrypt->encrypt($level->getLevel_code()) . '&lock='. $encrypt->encrypt(0)) ?>";
                       });
                   });
</script>
