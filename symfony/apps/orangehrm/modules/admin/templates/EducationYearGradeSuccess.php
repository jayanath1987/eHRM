...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Year Grade Summary") ?></h2></div>
        <?php echo message(); ?>
...
?>
        ...
        <br class="clear" />
        <form name="standardView" id="standardView" method="post" action="<?php echo url_for('admin/DeleteEducationYearGrade') ?>">
            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    ...
                    <?php
                            $row = 0;
                            foreach ($listEducationYearGrade as $EducationYearGrade ) {
                                $cssClass = ($row % 2) ? 'even' : 'odd';
                                $row = $row + 1;

                                                                
                                $id = $EducationYearGrade->grd_id;
                    ?>

                                <tr class="<?php echo $cssClass ?>">
                                    <td >
                                        <input type='checkbox' class='checkbox innercheckbox' name='chkID[]' id="chkID" value='<?php echo $EducationYearGrade->grd_year."_".$EducationYearGrade->edu_type_id; ?>' />
                            </td>

                            <td class="">
                                <a href="<?php echo url_for('admin/SaveEducationYearGrade?disId=' . $EducationYearGrade->grd_id.'&year='. ($EducationYearGrade->grd_year == null ? "null" : $EducationYearGrade->grd_year) .'&edut='. $EducationYearGrade->edu_type_id) ?>"><?php echo $EducationYearGrade->EducationType->edu_type_name ?></a>
                            </td>
                            <td>
                            <?php
                                echo $EducationYearGrade->grd_year;
                            ?>
                            </td>
                            <td>
<?php
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#btnAdd").click(function() {
                    location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/admin/SaveEducationYearGrade')) ?>";
