...
<div class="formpage4col" >
    ...
    <div class="outerbox">
        ...
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <input id="txtHiddenDisID"  name="txtHiddenDisID" type="hidden"  class="formInputText" value="<?php echo $EBExam->ebh_id; ?>" maxlength="100" />
            ...
            <div class="centerCol">
                ...
                <input id="txtEBName"  name="txtEBName" type="text"  class="formInputText" value="<?php
                    if (strlen($EBExam->ebh_exam_name)) {
                        echo $EBExam->ebh_exam_name;
                    } ?>" maxlength="100" />

            </div>
            <div class="centerCol">

                <input id="txtEBNameSi"  name="txtEBNameSi" type="text"  class="formInputText" value="<?php
                       if (strlen($EBExam->ebh_exam_name_si)) {
                           echo $EBExam->ebh_exam_name_si;
                       }
?>" maxlength="100" />
            ...
            <div class="centerCol">
                ...
                <input id="txtEBNameTa"  name="txtEBNameTa" type="text"  class="formInputText" value="<?php
                       if (strlen($EBExam->ebh_exam_name_ta)) {
                           echo $EBExam->ebh_exam_name_ta;
                       }
?>" maxlength="100" />
            ...
            <div class="centerCol">
                <select class="formSelect" <?php echo $disabled; ?> id="cmbGradeType" name="cmbGradeType">
                    ...
                    if ($GradeList) {
                        foreach ($GradeList as $Grade) {
                            ...
                            ?> <option 
                                ...
                                <?php if ($EBExam->grade_code == $Grade->grade_code) { ?>
                                    selected="selected"
                                <?php } ?>
            ...
            <div class="leftCol">
                <label for="txtLocationCode"><?php echo __("Experience Year") ?> </label>
            </div>
            ...
            <div class="centerCol">
                <select class="formSelect" <?php echo $disabled; ?> id="cmbYear" name="cmbYear">
                    <option value=""><?php echo __("--Select--"); ?></option>    
                    <?php for ($i = 1; $i <= 25; $i++) { ?>                 
                        <option <?php if ($i == $EBExam->ebh_exp_year) { ?>
                                selected="selected"
                        <?php } ?>
...
<!--                    <span class="required">*</span>-->
            ...
            <div id="bulkemp" >
                ...
                <div id="employeeGrid" class="centerCol" style="margin-left:10px; margin-top: 8px; width: 310px; border-style:  solid; border-color: #FAD163; ">
                    <div style="">
                        ...
                        <div class="centerCol" style='width:100px;  background-color:#FAD163;'>
                            <label class="languageBar" style="width:100px; padding-left:15px; padding-top:2px;padding-bottom: 1px; background-color:#FAD163; margin-top: 0px; color:#444444; text-align:inherit"><?php echo __("Pass Mark") ?></label>
                        </div>
                        <div class="centerCol" style='width:100px;   background-color:#FAD163;'>
    ...
    function InitializeData(){
        ...
        i=0;
         ...
         $.ajax({
                type: "POST",
                async:false,
                url: "<?php echo url_for('admin/LoadEBSubjects') ?>",
...
<?php if($EbExamDetail) foreach ($EbExamDetail as $Item) { ?>
    
                        childdiv="<div id='row_"+i+"' style='padding-top:0px; width:310px; height:25px;'>";
                        childdiv+="<div class='centerCol' id='master' style='width:100px; height:25px;'>";
                        childdiv+="<div id='employeename' style='height:25px; padding-top:0px;'>";
                        ...
                        childdiv+="<select style='width:90px; padding-top:0px;' class='formSelect' id='cmbSubject_"+i+"' name='cmbSubject_"+i+"'  ><option value=''>"+"<?php echo __('--Select--'); ?>"+"</option>";
                                $.each(subject, function(key, value) {
                                    ...
                                    if(word[0] == "<?php echo $Item['ebs_id']; ?>" ){
                        ...
                        childdiv+="<input type='text'  style='width:90px; color:#444444;' name='txtPassMark_"+i+"' id='txtPassMark_"+i+"'";

                        childdiv+="value='<?php if ($Item['ebd_pass_mark'] != null) echo $Item['ebd_pass_mark']; ?>'";
...
<?php } ?>
            ...
            function addtoGrid(empid){
                ...
                if (!$("#cmbGradeType").val()) {
                    alert('<?php echo __("Please Select Grade type") ?>');
                    return false;
                }
                ...
                if(newBS!=currentBS){
                    var bConfirmed = confirm("<?php echo __("Are you sure want to Generate Subject Slot ?") ?>");
                    if (bConfirmed){
                ...
                $.each(arraycp, function(key, value) { 
                    ...
                    childdiv="<div id='row_"+value+"' style='padding-top:0px; width:310px; height:25px;'>";
                    childdiv+="<div class='centerCol' id='master' style='width:100px; height:25px;'>";
                    childdiv+="<div id='employeename' style='height:25px; padding-top:0px;'>";
                    
                    childdiv+="<select style='width:90px; padding-top:0px;' class='formSelect' id='cmbSubject_"+key+"' name='cmbSubject_"+key+"'  ><option value=''>"+"<?php echo __('--Select--'); ?>"+"</option>";
                                $.each(subject, function(key, value) {
                                    var word=value.split("|");
                    ...
                    childdiv+="<div class='centerCol' id='master' style='width:100px; height:25px;'>";
                    childdiv+="<div id='employeename' style='height:25px; padding-top:10px; padding-left:3px;'>";
                    
                    childdiv+="<input type='text'  style='width:90px; color:#444444;' name='txtPassMark_"+value+"' id='txtPassMark_"+value+"'";                    
                    childdiv+=" onkeypress='return validationDesc(event,this.id)' maxlength='100' />";
...
txtEBName:{required : true },
cmbGradeType:{required : true }
},
messages: {

txtEBName:{required : "<?php echo __("This feild is Reuired.") ?>" },
cmbGradeType:{required : "<?php echo __("Please Select Grade") ?>" }
},
...
location.href="<?php echo url_for('admin/SaveEB_Exam?disId=' .$EBExam->ebh_id .'&lock=1') ?>";
}
else {
...
<?php if ($EBExam->ebh_id == null) { ?>
                           location.href="<?php echo url_for('admin/SaveEB_Exam') ?>";
<?php } else { ?>
                           location.href="<?php echo url_for('admin/SaveEB_Exam?disId=' . $EBExam->ebh_id .'&lock=0') ?>";
<?php } ?>
                    });
