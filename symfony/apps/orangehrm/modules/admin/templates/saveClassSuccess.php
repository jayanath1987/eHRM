...
<div class="formpage4col" >
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Add Class") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="<?php echo url_for('admin/saveClass'); ?>">
            <div class="leftCol">
                &nbsp;
            </div>
            <div class="centerCol">
            ...
            <div class="centerCol">
                ...
                <input id="txtGradeId"  name="txtClassId" type="hidden"  class="formInputText" value="" maxlength="100" />
            </div>
