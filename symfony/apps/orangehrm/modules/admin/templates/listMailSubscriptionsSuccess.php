...
<div class="formpageNarrow">
    <div class="outerbox">
        ...
        <div class="maincontent">
            ...
            <form action="" onsubmit="" method="post" id="frmSave" name="frmSave">
                ...
                <input type="checkbox"  class="formCheckbox" value="1" name="notificationMessageStatus[]" <?php if (isset($notficationList[1]) && $notficationList[1] == 1) {
    echo "checked='checked'";
} ?>"/>
                       <br class="clear"/>
                <label for="txtSkillName"><?php echo __("Leave Approvals") ?></label>

                <input type="checkbox"  class="formCheckbox" value="2" name="notificationMessageStatus[]" <?php if (isset($notficationList[2]) && $notficationList[2] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
                <label for="txtSkillName"><?php echo __("Leave Cancellations") ?></label>

                <input type="checkbox"  class="formCheckbox" value="0" name="notificationMessageStatus[]" <?php if (isset($notficationList[0]) && $notficationList[0] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
    ...
    echo "checked='checked'";
                ...
                <input type="checkbox"  class="formCheckbox" value="4" name="notificationMessageStatus[]" <?php if (isset($notficationList[4]) && $notficationList[4] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
                <label for="txtSkillName"><?php echo __("New employee hire approval requests") ?></label>

                <input type="checkbox"  class="formCheckbox" value="5" name="notificationMessageStatus[]" <?php if (isset($notficationList[5]) && $notficationList[5] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
                <label for="txtSkillName"><?php echo __("Tasks sent on hiring of employee") ?></label>

                <input type="checkbox"  class="formCheckbox" value="6" name="notificationMessageStatus[]" <?php if (isset($notficationList[6]) && $notficationList[6] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
                <label for="txtSkillName"><?php echo __("Notifications of hiring new employees") ?></label>

                <input type="checkbox"  class="formCheckbox" value="7" name="notificationMessageStatus[]" <?php if (isset($notficationList[7]) && $notficationList[7] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
                <label for="txtSkillName"><?php echo __("HSP Notifications") ?></label>

                <input type="checkbox"  class="formCheckbox" value="3" name="notificationMessageStatus[]" <?php if (isset($notficationList[3]) && $notficationList[3] == 1) {
    echo "checked='checked'";
} ?>/>
                <br class="clear"/>
