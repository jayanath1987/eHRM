        ...
        <form name="frmSearchBox" id="frmSearchBox" method="post" action="">
            ...
            <div class="searchbox">
                ...
                <select name="searchMode" id="searchMode">
                    ...
                    <option value="loc_code" <?php if ($searchMode == 'loc_code') {
            echo "selected";
        } ?>><?php echo __("ID") ?></option>
                    <option value="loc_name" <?php if ($searchMode == 'loc_name') {
            echo "selected";
        } ?>><?php echo __("Name") ?></option>
                    <option value="loc_city" <?php if ($earchMode == 'loc_city') {
            echo "selected";
        } ?>><?php echo __("City Name") ?></option>
                </select>
