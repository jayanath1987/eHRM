    ...
    <div class="outerbox">
        ...
        <form action="<?php echo url_for('admin/saveMailConfiguration'); ?>" onsubmit="" method="post" id="frmSave" name="frmSave">
            ...
            <select id="cmbMailSendingMethod" name="cmbMailSendingMethod" class="formSelect">
                <option value="SendMail" <?php if ($emailType == "sendmail") {
    echo "selected";
} ?> ><?php echo __("Send Mail") ?></option>
                <option value="SMTP" <?php if ($emailType == "smtp") {
    echo "selected";
} ?>><?php echo __("SMTP") ?></option>
            </select>
            <br class="clear"/>
            ...
            <div id="divSMTPControls" class="toggleDiv">
                ...
                <input type="radio" name="optAuth" id="optAuthNONE" class="formRadio" value="NONE" <?php if ($smtpAuth == '' || $smtpAuth == 'NONE') {
    echo "checked";
} ?> />
                <label for="optAuthNONE" class="optionlabel"><?php echo __("No") ?></label>
                <input type="radio" name="optAuth" id="optAuthLOGIN" class="formRadio" value="LOGIN" <?php if ($smtpAuth == 'LOGIN') {
    echo "checked";
} ?>/>
                ...
                <input type="radio" name="optSecurity" id="optSecurityNONE" class="formRadio" value="NONE" <?php if ($smtpSecurity == 'NONE') {
    echo "checked";
} ?> />
                <label for="optSecurityNONE"  class="optionlabel"><?php echo __("No"); ?></label>

                <input type="radio" name="optSecurity" id="optSecuritySSL" class="formRadio" value="SSL" <?php if ($smtpSecurity == 'SSL') {
    echo "checked";
} ?> />
                <label for="optSecuritySSL" class="optionlabel"><?php echo __("SSL") ?></label>

                <input type="radio" name="optSecurity" id="optSecurityTLS" class="formRadio" value="TLS" <?php if ($smtpSecurity == 'TLS') {
    echo "checked";
} ?> />
