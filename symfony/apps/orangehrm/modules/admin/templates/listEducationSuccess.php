        ...
        <form name="frmSearchBox" id="frmSearchBox" method="post" action="">
            ...
            <div class="searchbox">
                ...
                <select name="cmbSearchMode" id="cmbSearchMode">
                    ...
                    <option value="edu_name" selected><?php echo __("Education Name") ?></option>
                </select>
            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    <tr>
                        ...
                        <td scope="col">
<?php echo $sorter->sortLink('edu_name', __('Education Name'), '@education_list', ESC_RAW); ?>
                        </td>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    foreach ($listEducation as $education) {
                        ...
                        $educationName = $education->$educationNameCol == "" ? $education->edu_name : $education->$educationNameCol;

                        $id = $education->edu_code;
                    ?>

                        <tr class="<?php echo $cssClass ?>">
                            <td >
                                <input type='checkbox' class='checkbox innercheckbox' name='chkID[]' id="chkID" value='<?php echo $education->edu_code ?>' />
                            </td>
                            <td class="">
                                
                            </td>
                            <td class="">
                                <a href="<?php echo url_for('admin/updateEducation?id=' . $encrypt->encrypt($id)) ?>"><?php echo $educationName ?></a>
                            </td>
                        </tr>
<?php } ?>
                </tbody>
