...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Grades") ?></h2></div>
        <?php echo message(); ?>
        <form name="frmSearchBox" id="frmSearchBox" method="post" action="">
            ...
            <div class="searchbox">
                ...
                <select name="cmbSearchMode" id="cmbSearchMode">
                    ...
                    <option value="grade_name" selected><?php echo __("Grade Name") ?></option>
                </select>
        ...
        <br class="clear" />
        <form name="standardView" id="standardView" method="post" action="<?php echo url_for('admin/deleteGrade') ?>">
...
<?php echo $sorter->sortLink('grade_name', __('Grade Name'), '@grade_list', ESC_RAW); ?>
                        </td>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr class="<?php echo $cssClass ?>">
                            <td >
                                <input type='checkbox' class='checkbox innercheckbox' name='chkLocID[]' id="chkLoc" value='<?php echo $grade->grade_code ?>' />
                            </td>
                            <td class="">
                                <a href="<?php echo url_for('admin/UpdateGrade?id=' . $encrypt->encrypt($grade->grade_code)); ?>"><?php echo $GradeName ?></a>
                            </td>
