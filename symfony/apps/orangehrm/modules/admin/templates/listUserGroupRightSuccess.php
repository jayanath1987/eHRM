...
<div class="formpage">
    ...
    <div class="outerbox">
        ...
        <div class="maincontent">
            <?php if ($userGroup->getUsergId() != $currentUserGroup) {
 ?>
...
<?php } else { ?>
                <div class="notice">Your login account belongs to the same User Group, you are not allowed change rights to this group</div>
<?php } ?>
        </div>
        <div class="bottom">
            <div class="left"></div>
...
<?php foreach ($moduleRights as $right) { ?>
                        <tr>
                            ...
                            <td><?php if ($right->getAddition() == 1) {
                    echo "Yes";
                } else {
                    echo "No";
                } ?></td>
                            <td><?php if ($right->getEditing() == 1) {
                            echo "Yes";
                        } else {
                            echo "No";
                        } ?></td>
                            <td><?php if ($right->getDeletion() == 1) {
                            echo "Yes";
                        } else {
                            echo "No";
                        } ?></td>
                            <td><?php if ($right->getViewing() == 1) {
                            echo "Yes";
                        } else {
                            echo "No";
                        } ?></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnBack").click(function() {
            location.href = "<?php echo url_for("admin/updateUserGroup?id=" . $userGroup->getUsergId()) ?>";
        });
