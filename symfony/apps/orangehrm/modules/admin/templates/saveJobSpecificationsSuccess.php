...
<div class="formpage">
    ...
    <div class="outerbox">
        ...
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <textarea id="txtDesc" class="formTextArea" tabindex="2" name="txtDesc" type="text"></textarea>
            <br class="clear"/>
            <label for="txtDuties"><?php echo __("Duties") ?></label>
            <textarea id="txtDuties" class="formTextArea" tabindex="3" name="txtDuties" type="text"></textarea>
            <br class="clear"/>
