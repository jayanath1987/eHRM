...
<div class="formpage4col" >
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Education Type") ?></h2></div>
        <?php echo message() ?>
        <form name="frmSave" id="frmSave" method="post"  action="<?php echo url_for('admin/SaveEducationType'); ?>">
            <input type="hidden" id="txtHiddenETID" name="txtHiddenETID" value="<?php echo $EducationType->edu_type_id ?>"/>
            <div class="leftCol">
                &nbsp;
            </div>
            <div class="centerCol">
            ...
            <div class="centerCol">
                ...
                <input id="txtEducationTypeName"  name="txtEducationTypeName" type="text"  class="formInputText" value="<?php
                    if (strlen($EducationType->edu_type_name)) {
            ...
            <div class="centerCol">
                ...
                <input id="txtEducationTypeNameSi"  name="txtEducationTypeNameSi" type="text"  class="formInputText" value="<?php
                       if (strlen($EducationType->edu_type_name_si)) {
                           echo $EducationType->edu_type_name_si;
                       }
?>" maxlength="100" />
            ...
            <div class="centerCol">
                ...
                <input id="txtEducationTypeNameTa"  name="txtEducationTypeNameTa" type="text"  class="formInputText" value="<?php
                       if (strlen($EducationType->edu_type_name_ta)) {
                           echo $EducationType->edu_type_name_ta;
                       }
?>" maxlength="100" />
...
<?php } ?>
           ...
           $("#editBtn").click(function() {
               ...
               if (editMode == 1) {
                   ...
                   location.href="<?php echo url_for('admin/SaveEducationType?ETId=' . $encrypt->encrypt($EducationType->edu_type_id) . '&lock=1') ?>";
               }
               else {
           ...
           $("#btnClear").click(function() {
               if($("#frmSave").data('edit') != 1){
                   location.href="<?php echo url_for('admin/SaveEducationType?ETId=' . $encrypt->encrypt($EducationType->edu_type_id) . '&lock=0') ?>";
               }else{
