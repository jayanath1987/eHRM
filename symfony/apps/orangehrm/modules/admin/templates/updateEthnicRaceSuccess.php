...
<div class="formpage">
    <div class="navigation">
        <input type="button" class="backbutton" id="btnBack" name="btnBack"
    ...
    <div class="outerbox">
        ...
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <input id="txtEthnicRaceDesc"  name="txtEthnicRaceDesc" type="text"  class="formInputText" value="<?php echo $ethnicRace->getEthnicRaceDesc() ?>" tabindex="1" />
            <br class="clear"/>
