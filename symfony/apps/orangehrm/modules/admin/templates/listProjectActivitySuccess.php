...
<div class="formpage">
 ...
 ?>
                        <option value="<?php echo $project->getProjectId() ?>" <?php if ($currentProject == $project->getProjectId()) {
                            echo "selected";
                        } ?>><?php echo $project->getName() . '-' . $project->getCustomer()->getName() ?></option>
<?php } ?>
                </select>
            </form>
            <br class="clear"/>
...
<?php if ($hasProjectActivity) { ?>
                        <form action="<?php echo url_for("admin/deleteProjectActivity") ?>" method="post" name="frmRemoveProjectAdmin" id="frmRemoveProjectAdmin">
                            <input type="hidden" name="id" id="id" value="<?php echo $currentProject ?>"/>
