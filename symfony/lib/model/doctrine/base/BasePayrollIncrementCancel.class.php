 ...
 */
abstract class BasePayrollIncrementCancel extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('hs_pr_increment_cancel');
        ...
        $this->hasColumn('inc_cancel_oder', 'integer', 11, array(
             'type' => 'integer',
             'primary' => true,
             'length' => '11',
             ));
