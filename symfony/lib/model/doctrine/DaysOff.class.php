 ...
 */
class DaysOff extends BaseDaysOff
{
    const DAYSOFF_LENGTH_FULL_DAY 	= 0;
    const DAYSOFF_LENGTH_HALF_DAY 	= 4;
    const DAYSOFF_LENGTH_WEEKEND 	= 8;

    private $daysList = array(1=>'Monday', 2=>'Tuesday', 3=>'Wednesday', 4=>'Thursday', 5=>'Friday', 6=>'Saturday', 7=>'Sunday');

    private $daysLengthList = array ( 0 => 'Full Day', 4=> 'Half Day', 8 => 'Weekend');
