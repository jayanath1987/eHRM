...
class BaseEmployeeLanguageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'code'       => new sfValidatorDoctrineChoice(array('model' => 'EmployeeLanguage', 'column' => 'lang_code', 'required' => false)),
      'lang_type'  => new sfValidatorDoctrineChoice(array('model' => 'EmployeeLanguage', 'column' => 'elang_type', 'required' => false)),
