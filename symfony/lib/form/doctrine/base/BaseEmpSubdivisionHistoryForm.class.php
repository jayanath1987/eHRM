...
/**
 * EmpSubdivisionHistory form base class.
 *
 * @package    form
 * @subpackage emp_subdivision_history
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseEmpSubdivisionHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'         => new sfValidatorDoctrineChoice(array('model' => 'EmpSubdivisionHistory', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('emp_subdivision_history[%s]');
