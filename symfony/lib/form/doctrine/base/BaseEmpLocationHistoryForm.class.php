...
/**
 * EmpLocationHistory form base class.
 *
 * @package    form
 * @subpackage emp_location_history
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseEmpLocationHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'         => new sfValidatorDoctrineChoice(array('model' => 'EmpLocationHistory', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('emp_location_history[%s]');
