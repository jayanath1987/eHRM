	...
	methods: {
		...
		equalTo: function(value, element, param) {
			return value == $(param).val();
                ...
                noSpecialChars:  function(value, element, param){
                    //return this.optional(element) || /^[^a-z0-9\_ .]+$/i.test(value);
                    return this.optional(element) || /^[^<>@\*\!|#\$%\^()~`'\+=]+$/i.test(value);
                },
                noSpecialCharsWithBrackets:  function(value, element, param){
                    //return this.optional(element) || /^[^a-z0-9\_ .]+$/i.test(value);
                    return this.optional(element) || /^[^<>@\*\!|#\$%\^~`'\+=]+$/i.test(value);
                },
                noSpecialCharsOnly:  function(value, element, param){
                    //return this.optional(element) || /^[^a-z0-9\_ .]+$/i.test(value);
                    return this.optional(element) || /^[^<>@\*\!|#\$%\^()~`'\+=]+$/i.test(value);
                },
                ...
                alphaCharacters: function(value, element,param) {
                    var flag=true;
                    var i,code;
                    ...
                    for(i=0;element.value.length>i;i++)
                    {
                        code=element.value.charCodeAt(i);
                ...
                orange_date: function(value, element, params) {
                    var hint = params[0];
                    var format = params[1];
                ...
                comboSelected: function(value, element) {
                    return value != "0";
                }
        }
